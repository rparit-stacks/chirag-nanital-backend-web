...
class WalletController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        $seller = $this->seller;
        // Get the seller's payout wallet (separate from their customer wallet)
        $walletResult = $this->walletService->getWallet($seller->user->id, WalletTypeEnum::SELLER);
    ...
    public function getTransactions(Request $request): JsonResponse
    {
        ...
        // Get the transactions (scoped to the seller's wallet only)
        $result = $this->walletService->getTransactions($seller->user->id, $filters, WalletTypeEnum::SELLER);
