...
class ProductApiController extends Controller
{
    ...
    public function storeWise(Request $request): JsonResponse
    {
        ...
        $query = Product::with([
            ...
            // them from there and falls back to the catalog defaults when no inventory row exists.
            'variants.storeVariantAddons' => function ($q) use ($storeId) {
                $q->where('store_id', $storeId);
            },
    ...
    public function search(Request $request): JsonResponse
    {
        return $this->zoneSearch(
            ...
            app(ProductService::class)->getAvailableProductsByZoneIds(
            ...
            successMessage: 'labels.products_fetched_successfully',
            errorMessage:   'labels.error_fetching_products',
        );
    }
}
