...
use App\Listeners\DeliveryBoy\HandleDeliveryBoyReferralOnVerification;
...
class EventServiceProvider extends ServiceProvider
{
    ...
    protected array $listen = [
        ...
        // Delivery Boy Verification Events
        DeliveryBoyVerificationStatusUpdated::class => [
            HandleDeliveryBoyReferralOnVerification::class,
        ],

        // Delivery Boy Status Events
