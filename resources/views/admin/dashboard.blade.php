                        ...
                        <div class="card card-sm">
                            <a href="{{ route('admin.sellers.index') }}" class="card-body text-decoration-none">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col">
                                        <div class="font-weight-medium">{{$adminInsights['total_sellers']}}
                                            {{ __('labels.sellers') }}</div>
                                        <div class="text-secondary">{{$adminInsights['total_stores']}}
                        ...
                        <div class="card card-sm">
                            <a href="{{ route('admin.orders.index') }}" class="card-body text-decoration-none">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col">
                                        <div class="font-weight-medium">{{$adminInsights['total_orders']}}
                                            {{ __('labels.orders') }}</div>
                                        <div class="text-secondary">{{$adminInsights['total_delivered_orders']}}
                        ...
                        <div class="card card-sm">
                            <a href="{{ route('admin.delivery-boys.index') }}" class="card-body text-decoration-none">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col">
                                        <div class="font-weight-medium">{{$adminInsights['total_active_delivery_boys']}}
                                            {{ __('labels.active_delivery_boys') }}</div>
                                        <div class="text-secondary">{{$adminInsights['total_delivery_boys']}}
                        ...
                        <div class="card card-sm">
                            <a href="{{ route('admin.products.index') }}" class="card-body text-decoration-none">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col">
                                        <div class="font-weight-medium">{{ $adminInsights['total_products'] }}
                                            {{ __('labels.products') }}</div>
                                        <div class="text-secondary">{{ $adminInsights['total_product_sales'] }}
