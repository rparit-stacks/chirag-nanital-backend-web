...
@section('admin-content')
                                ...
                                <div class="card mb-4" id="pills-sms-gateway">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="alert alert-info">
                                            ...
                                            <ul class="mb-0 mt-2">
                                                <li>If Custom SMS is enabled → Gateway: <strong>Custom</strong>
                                                    (Priority)
                                                </li>
                                                <li>If Custom SMS is disabled but Firebase is enabled → Gateway:
                                                    <strong>Firebase</strong></li>
                                                <li>If both are disabled → Gateway: <strong>Not Set</strong></li>
                                            </ul>
                                            <small class="text-muted">Both Firebase and Custom SMS can be enabled
                                                simultaneously. Custom SMS takes priority when enabled.</small>
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label">Current SMS Gateway:</label>
                                            <span id="activeSmsGateway" class="badge bg-secondary">Not Set</span>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="mb-3">
                                            <label class="row">
                                                ...
                                                <span class="col-auto">
                                                        <label class="form-check form-check-single form-switch">
                                                            <input class="form-check-input" type="checkbox"
                                                                   name="appleLogin" value="1" checked disabled/>
                                                        </label>
                                                    </span>
                                                <small class="form-text text-muted">{{ __('labels.apple_will_be_always_enable_for_apple_user') }}</small>
                                            </label>
                                        </div>
                                        <div class="mb-3">
                                            <label class="row">
    ...
    <script src="{{ asset('js/admin/authentication-settings.js') }}"></script>
@endsection
