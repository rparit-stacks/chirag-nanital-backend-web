...
@section('admin-content')
    <div class="page-body">
        <div class="row row-cards">
                    ...
                    <div class="card">
                        <a href="{{route('admin.settings.show', ['setting' => 'system'])}}" class="card-link">
                            ...
                            <div class="card-body py-5">
                                <h3 class="card-title">{{ __('labels.system_title') }}</h3>
                                <p class="text-secondary">
                                    {{ __('labels.system_description') }}
                                </p>
                            </div>
                        </a>
                    </div>
            ...
            @endcan
            @can('viewSetting', [\App\Models\Setting::class, 'system_update_settings'])
                <div class="col-md-6 col-lg-4">
                    <div class="card">
                        <a href="{{route('admin.settings.show', ['setting' => 'system_update_settings'])}}" class="card-link">
                            <div class="card-stamp">
                                <div class="card-stamp-icon bg-primary">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            ...
                            <div class="card-body py-5">
                                <h3 class="card-title">{{ __('labels.system_update_settings') ?? 'System Update Settings' }}</h3>
                                <p class="text-secondary">
                                    {{ __('labels.system_update_settings_description') ?? 'Manage the messages shown during force and soft application updates.' }}
                                </p>
                            </div>
                        </a>
                    </div>
            ...
            @can('viewSetting', [\App\Models\Setting::class, 'notification'])
                <div class="col-md-6 col-lg-4">
                    <div class="card">
                        <a href="{{route('admin.settings.show', ['setting' => 'notification'])}}" class="card-link">
                            <div class="card-stamp">
                                <div class="card-stamp-icon bg-primary">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
            ...
            @can('viewSetting', [\App\Models\Setting::class, 'home_general_settings'])
                <div class="col-md-6 col-lg-4">
                    <div class="card">
                        <a href="{{route('admin.settings.show', ['setting' => 'home_general_settings'])}}" class="card-link">
                            <div class="card-stamp">
                                <div class="card-stamp-icon bg-primary">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
