...
// Schedule referral earnings settlement to run daily at 3 AM
// Settles pending earnings whose return window (return_deadline) has expired
Schedule::command('referral:settle')->dailyAt('03:00');
